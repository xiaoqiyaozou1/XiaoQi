...
namespace XiaoQi.Controllers
{
    ...
    public class SysConfigController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public IActionResult GetConfigPages(int pageIndex, int pageSize, string name)
        {
            var data = _sysConfigService.GetPageInfos(pageIndex, pageSize, out int total, o=>o.Id!=null, o => o.CreateTime, true);
